...
**Use HttpOnly cookies** — prevents JavaScript access to user sessions.
...
**Set reasonable session expiry** — 7 days is common.
...
| Version | Changes |
|---------|---------|
| v0.12.0 | Added session extension |
| v0.11.0 | Added CSRF protection |
| v0.10.0 | Initial auth support |
