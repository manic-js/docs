...
The Vercel provider transforms Manic's unified `.manic/` output into the [Vercel Build Output API](https://vercel.com/docs/build-output-api/v3) (v3) layout.
...
<Files>
  <Folder name=".vercel/output" defaultOpen>
    <File name="config.json" />
    <File name=".vc-config.json" />
    <Folder name="static" />
